"""
Django settings for geminiProject project.
...
SECRET_KEY = 'django-insecure--hyjo97z1)n8l+fiev8=#w9unt($#z0q4#wgb7+s!@z+tx%y^u'
...
ROOT_URLCONF = 'geminiProject.urls'
...
WSGI_APPLICATION = 'geminiProject.wsgi.application'
...
AUTHENTICATION_BACKENDS = [
    ...
    'authentication.backend.CustomUserAuthenticationBackend',  # Custom backend for Student model
]
